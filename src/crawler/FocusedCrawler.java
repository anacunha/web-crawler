...
public class FocusedCrawler {
    ...
    public FocusedCrawler(String seed, String keyword) {
    ...
    public void crawl() {
        ...
        while(count < MAX_PAGES_TO_CRAWL) {
            ...
            try {
                ...
                if(!hasBeewnCrawled(currentPage)) {
    ...
    private void saveURLs() {
        try {
            FileWriter urlsFile = new FileWriter("urls_task2_bfs.txt");
    ...
    public void saveDocuments() {
        ...
        try {
            docsFile = new FileWriter("docs_task2_bfs.txt");
